...
**Total: 21 public types + 2 package-private types (`SelfProducedFilter`, `MaterializedStateQueryService`) + 1 module-info.java = 24 production Java files** (M4.0a added 1 public type — `AtomicCheckpointSink`; M3.6e.1 added 1 package-private type — `MaterializedStateQueryService` — and 1 public static factory method on `StateQueryService`).
