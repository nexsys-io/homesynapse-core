...
/**
 * Standard read-only capability for ambient light level measurement.
 *
 * <p>Provides a single float attribute ({@code illuminance_lux}) in lux.
 * No commands. Confirmation is {@link ConfirmationMode#DISABLED}.</p>
 *
 * <p>Capability ID: {@code "illuminance_measurement"}. Defined in Doc 02 §3.6.</p>
 *
 * @param capabilityId the capability identifier, always {@code "illuminance_measurement"} for standard instances
 ...
 * @since 1.0
 */
public record IlluminanceMeasurement(
        String capabilityId,
        int version,
        String namespace,
