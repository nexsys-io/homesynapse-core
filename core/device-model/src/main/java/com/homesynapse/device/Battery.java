...
/**
 * Standard read-only capability for battery status reporting.
 *
 * <p>Provides two attributes: {@code battery_pct} (integer, 0–100) for the
 * battery charge percentage, and {@code battery_low} (boolean) as a
 * threshold-based low-battery indicator.</p>
 *
 * <p>No commands. Confirmation is {@link ConfirmationMode#DISABLED}.</p>
 *
 * <p>Capability ID: {@code "battery"}. Defined in Doc 02 §3.6.</p>
 *
 * @param capabilityId the capability identifier, always {@code "battery"} for standard instances
