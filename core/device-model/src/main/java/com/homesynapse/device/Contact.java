...
/**
 * Standard read-only capability for contact/door/window open/close sensing.
 *
 * <p>Provides a single boolean attribute ({@code open}): {@code true} when
 * the contact is open (door/window ajar), {@code false} when closed.</p>
 *
 * <p>No commands. Confirmation is {@link ConfirmationMode#DISABLED}.</p>
 *
 * <p>Capability ID: {@code "contact"}. Defined in Doc 02 §3.6.</p>
 *
 * @param capabilityId the capability identifier, always {@code "contact"} for standard instances
