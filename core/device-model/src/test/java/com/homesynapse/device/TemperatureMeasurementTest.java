...
/**
 * Tests for {link TemperatureMeasurement} — standard capability record.
 */
...
class TemperatureMeasurementTest {
    ...
    private static final ConfirmationPolicy POLICY = new ConfirmationPolicy(
            ConfirmationMode.DISABLED, List.of("temperature_c"), null, 5000L);

    private static TemperatureMeasurement sample() {
        return new TemperatureMeasurement("temperature_measurement", 1, "core", Map.of(), Map.of(), POLICY);
    }
    ...
    class ConstructionTests {
        ...
        void allFieldsAccessible() {
            TemperatureMeasurement cap = sample();
            assertThat(cap.capabilityId()).isEqualTo("temperature_measurement");
        ...
        void exactlySixFields() {
            assertThat(TemperatureMeasurement.class.getRecordComponents()).hasSize(6);
        }
        ...
        void isRecord() {
            assertThat(TemperatureMeasurement.class.isRecord()).isTrue();
        }
    }
    ...
    class EqualsHashCodeTests {
        ...
        void differentNotEqual() {
            TemperatureMeasurement a = sample();
            TemperatureMeasurement b = new TemperatureMeasurement("other", 1, "core", Map.of(), Map.of(), POLICY);
