...
/**
 * Tests for {@link Brightness} — brightness level control capability.
 */
...
class BrightnessTest {
    ...
    private static Brightness sample() {
        return new Brightness("brightness", 1, "core", Map.of(), Map.of(), POLICY);
    }
    ...
    class ConstructionTests {
        ...
        void allFieldsAccessible() {
            Brightness cap = sample();
            assertThat(cap.capabilityId()).isEqualTo("brightness");
        ...
        void exactlySixFields() {
            assertThat(Brightness.class.getRecordComponents()).hasSize(6);
        }
        ...
        void isRecord() {
            assertThat(Brightness.class.isRecord()).isTrue();
        }
    }
    ...
    class EqualsHashCodeTests {
        ...
        void differentNotEqual() {
            Brightness a = sample();
            Brightness b = new Brightness("other", 1, "core", Map.of(), Map.of(), POLICY);
