...
/**
 * Tests for {link Occupancy} — standard capability record.
 */
@DisplayName("Occupancy")
class OccupancyTest {

    private static final ConfirmationPolicy POLICY = new ConfirmationPolicy(
            ConfirmationMode.DISABLED, List.of("occupied"), null, 5000L);

    private static Occupancy sample() {
        return new Occupancy("occupancy", 1, "core", Map.of(), Map.of(), POLICY);
    }
    ...
    class ConstructionTests {
        ...
        void allFieldsAccessible() {
            Occupancy cap = sample();
            assertThat(cap.capabilityId()).isEqualTo("occupancy");
        ...
        void exactlySixFields() {
            assertThat(Occupancy.class.getRecordComponents()).hasSize(6);
        }
        ...
        void isRecord() {
            assertThat(Occupancy.class.isRecord()).isTrue();
        }
    }
    ...
    class EqualsHashCodeTests {
        ...
        void differentNotEqual() {
            Occupancy a = sample();
            Occupancy b = new Occupancy("other", 1, "core", Map.of(), Map.of(), POLICY);
