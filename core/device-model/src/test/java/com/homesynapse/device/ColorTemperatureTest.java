...
/**
 * Tests for {@link ColorTemperature} — color temperature control capability.
 */
@DisplayName("ColorTemperature")
class ColorTemperatureTest {
    ...
    private static ColorTemperature sample() {
        return new ColorTemperature("color_temperature", 1, "core", Map.of(), Map.of(), POLICY);
    }
    ...
    class ConstructionTests {
        ...
        void allFieldsAccessible() {
            ColorTemperature cap = sample();
            assertThat(cap.capabilityId()).isEqualTo("color_temperature");
        ...
        void exactlySixFields() {
            assertThat(ColorTemperature.class.getRecordComponents()).hasSize(6);
        }
        ...
        void isRecord() {
            assertThat(ColorTemperature.class.isRecord()).isTrue();
        }
    }
    ...
    class EqualsHashCodeTests {
        ...
        void differentNotEqual() {
            ColorTemperature a = sample();
            ColorTemperature b = new ColorTemperature("other", 1, "core", Map.of(), Map.of(), POLICY);
