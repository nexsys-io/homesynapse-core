 ...
 * {@code false} result. All conditions must evaluate to {@code true} for
 * the conjunction to be {@code true}.</p>
 *
 * <p>Defined in Doc 07 §3.8, §8.2.</p>
 *
 * @param conditions the sub-conditions to conjoin, unmodifiable, never {@code null}
 * @see ConditionDefinition
 * @see ConditionEvaluator
 */
public record AndCondition(List<ConditionDefinition> conditions) implements ConditionDefinition {
