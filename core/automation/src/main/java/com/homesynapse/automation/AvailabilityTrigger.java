...
/**
 * Fires on entity-subject {@code availability_changed} events matching the target
 * availability state.
 *
 ...
 *
 * <p>The device-subject counterpart is {@link ReachabilityTrigger} (AMD-88).</p>
 *
...
public record AvailabilityTrigger(
     ...
     *
     * @throws NullPointerException if {@code selector}, {@code targetAvailability},
