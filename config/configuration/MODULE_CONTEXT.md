...
- **M6.1 status (2026-06-10):** **COMPLETE — both halves delivered.** M6.1b (access/events, AMD-66/67/70 shapes) committed `b7bc65c`, gate GREEN. **M6.1a (load/validate) files produced 2026-06-10, build gate deferred to Nick:** `YamlLoader`, `JsonSchemaCompositeValidator`, `StandardSchemaRegistry`, `StandardConfigurationService` + `YamlLoaderTest`/`ConfigLayoutTest`/`JsonSchemaCompositeValidatorTest`/`StandardConfigurationServiceTest` (+`RecordingEventPublisher` test helper), the module-info/Gradle ruling applied, AMD-71 layout/include/traversal-guard behavior, the AMD-70 publish path, AMD-66 registration. See `coder-handoff.md` for the deferred gate commands.
